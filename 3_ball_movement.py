...
# screen이라는 변수에 화면 크기 설정(= pygame.display.set_mode((screen_width, screen_heigth))) 넣는다
...
# 캐릭터 이동 방향
character_to_x = 0 # Y축 필요없음 좌우로만 움직이므로
...
while running:
    ...
    # 무기 위치 조정
            # 100,   200 -> 180, 160, 140 ...  -> x좌표값(w[0])은 고정 / y좌표값(w[1])은 스피드에 따라 값 바뀜 
            # x좌표  y좌표
